    ...
    <>
      <Column className="bg-white_A700 font-kd items-center justify-end mx-[auto] w-[100%]">
        <Column className="bg-white_A700 items-center justify-end lg:p-[5px] 2xl:p-[6px] xl:p-[6px] 3xl:p-[8px] w-[100%]">
          ...
          <Row className="justify-center lg:mt-[15px] xl:mt-[18px] 2xl:mt-[20px] 3xl:mt-[24px] w-[34%]">
            <Img
              src="images/img_arrow2.svg"
              className="lg:h-[2px] 3xl:h-[3px] 2xl:h-[3px] xl:h-[3px] lg:mt-[19px] xl:mt-[22px] 2xl:mt-[24px] 3xl:mt-[29px] w-[1px]"
              alt="ArrowTwo"
            />
            <Text className="font-normal 3xl:ml-[101px] lg:ml-[65px] xl:ml-[75px] 2xl:ml-[84px] not-italic lg:text-[30px] xl:text-[35px] 2xl:text-[39px] 3xl:text-[47px] text-black_900 w-[auto]">
              Dun & Bradstreet
            </Text>
            <Img
              src="images/img_arrow2_black_900.svg"
              className="lg:h-[2px] 3xl:h-[3px] 2xl:h-[3px] xl:h-[3px] 3xl:ml-[102px] lg:ml-[66px] xl:ml-[76px] 2xl:ml-[85px] lg:mt-[19px] xl:mt-[22px] 2xl:mt-[24px] 3xl:mt-[29px] w-[1px]"
              alt="ArrowTwo One"
            />
          </Row>
          <PagerIndicator
            className="h-[7px] xl:mt-[11px] 2xl:mt-[12px] 3xl:mt-[14px] lg:mt-[9px] w-[max-content]"
            count={3}
          ...
          <Column className="absolute bg-bluegray_50 items-center left-[0] lg:p-[16px] xl:p-[19px] 2xl:p-[21px] 3xl:p-[25px] w-[100%]">
            <Row className="w-[82%]">
              ...
              <Column className="bg-white_A700 items-center lg:p-[14px] xl:p-[17px] 2xl:p-[19px] 3xl:p-[22px] rounded-radius8 shadow-bs4 w-[43%]">
                <Row className="lg:mt-[4px] 2xl:mt-[5px] xl:mt-[5px] 3xl:mt-[6px] w-[99%]">
                  <Text className="font-extrabold mt-[1px] lg:text-[13px] xl:text-[15px] 2xl:text-[16px] 3xl:text-[20px] text-black_900 w-[auto]">
                    PayDex
                  </Text>
                  <Img
                    src="images/img_arrowdown.svg"
                    className="lg:h-[14px] xl:h-[16px] 2xl:h-[17px] 3xl:h-[21px] mb-[1px] lg:ml-[240px] xl:ml-[275px] 2xl:ml-[309px] 3xl:ml-[371px] w-[2%]"
                    alt="arrowdown"
                  />
                ...
                <Text className="font-extrabold lg:mt-[32px] xl:mt-[37px] 2xl:mt-[41px] 3xl:mt-[49px] lg:text-[13px] xl:text-[15px] 2xl:text-[16px] 3xl:text-[20px] text-teal_A400_d8 w-[auto]">
                  50
                </Text>
...
export default ExperianScoresPage;
