    ...
    <>
      <Column className="bg-white_A700 font-kd items-center justify-end mx-[auto] w-[100%]">
        <Column className="bg-white_A700 items-center justify-end lg:p-[5px] 2xl:p-[6px] xl:p-[6px] 3xl:p-[8px] w-[100%]">
          ...
          <Row className="justify-center lg:mt-[14px] xl:mt-[17px] 2xl:mt-[19px] 3xl:mt-[22px] w-[34%]">
            <Img
              src="images/img_arrow2.svg"
              className="lg:h-[2px] 3xl:h-[3px] 2xl:h-[3px] xl:h-[3px] lg:mt-[20px] xl:mt-[23px] 2xl:mt-[25px] 3xl:mt-[31px] w-[1px]"
              alt="ArrowTwo"
            />
            ...
            <Img
              ...
              className="lg:h-[2px] 3xl:h-[3px] 2xl:h-[3px] xl:h-[3px] 3xl:ml-[102px] lg:ml-[66px] xl:ml-[76px] 2xl:ml-[85px] lg:mt-[20px] xl:mt-[23px] 2xl:mt-[25px] 3xl:mt-[31px] w-[1px]"
              alt="ArrowTwo One"
            />
          </Row>
          <PagerIndicator
            className="h-[7px] lg:mt-[10px] xl:mt-[12px] 2xl:mt-[13px] 3xl:mt-[16px] w-[max-content]"
            count={3}
