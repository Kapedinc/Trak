      ...
      <Column className="bg-white_A700 font-kd items-center justify-end mx-[auto] w-[100%]">
        <header className="w-[100%]">
          <Column className="bg-white_A700 items-center justify-end lg:p-[5px] 2xl:p-[6px] xl:p-[6px] 3xl:p-[8px] w-[100%]">
            ...
            <Row className="justify-center lg:mt-[18px] xl:mt-[21px] 2xl:mt-[23px] 3xl:mt-[28px] w-[34%]">
              <Img
              ...
              <Img
                ...
                className="lg:h-[2px] 3xl:h-[3px] 2xl:h-[3px] xl:h-[3px] lg:ml-[134px] xl:ml-[154px] 2xl:ml-[173px] 3xl:ml-[208px] lg:mt-[16px] xl:mt-[19px] 2xl:mt-[21px] 3xl:mt-[25px] w-[1px]"
                alt="ArrowTwo One"
              />
            </Row>
            <PagerIndicator
...
export default ReportsEquifaxPage;
